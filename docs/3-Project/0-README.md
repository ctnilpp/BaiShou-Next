...
项目介绍（多语言）。顶部语言栏在各 README 中一致，可随时切换。

| 语言     | 文档                                                                    |
| -------- | ----------------------------------------------------------------------- |
| 简体中文 | [仓库主页 README.md](../../README.md)（[docs 内跳转](README_ZH-CN.md)） |
...
| 语言     | 文档                                                                       |
| -------- | -------------------------------------------------------------------------- |
| 简体中文 | [../../Latte/角色设定.md](../../Latte/角色设定.md)                         |
| 繁體中文 | [../../Latte/角色設定.md](../../Latte/角色設定.md)                         |
